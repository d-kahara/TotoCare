...
public class week36Activity extends AppCompatActivity {
    WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_week36);
        webView = findViewById(R.id.webView_week36);
        ...
        webView.loadDataWithBaseURL("https://human.biodigital.com/widget?be=2FQi&background=255,255,255,51,64,77&dk=cdebb09e9dae744e152efa10c45212aa06fddd34", data_html, "text/html", "UTF-8", null);
